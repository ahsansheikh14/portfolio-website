  ...
  return (
    ...
    >
        ...
        <motion.div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {project.tech.map((t) => (
              <span
                key={t}
                className="px-2.5 py-1 text-xs font-mono rounded-md bg-white/5 border border-white/10 text-accent/90"
              >
                {t}
              </span>
            ))}
      ...
      <div className={`hidden lg:flex justify-center ${!isEven ? "lg:order-1" : ""}`}>
        <motion.div
          className="w-full max-w-md aspect-video rounded-2xl border border-white/10 flex items-center justify-center relative overflow-hidden"
