...
export default function Footer() {
  return (
    <footer className="relative py-10 border-t border-theme overflow-hidden">
      <motion.div
      ...
      <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
        <motion.p
          className="text-sm text-body flex items-center justify-center gap-2 flex-wrap"
          initial={{ opacity: 0 }}
        ...
        <p className="mt-2 text-xs text-body/80 font-mono">
